...
import datastructures.basics.BasicQueue;
import datastructures.contracts.Queue;

public class SnowbirdLiftAppQueue {
	Queue<Gad2Chair> gad2LiftQueue = new BasicQueue<Gad2Chair>();

	public static void main(String[] args) {
		SnowbirdLiftAppQueue app = new SnowbirdLiftAppQueue();
		app.runLift();
	}
	...
	class Gad2Chair {
		...
		private SnowbirdLiftAppQueue getOuterType() {
			return SnowbirdLiftAppQueue.this;
		}
	}
}
