...
public class SnowbirdLiftAppBasicQueue {
	Queue<Gad2Chair> gad2LiftQueue = new BasicQueue<>();

	public static void main(String[] args) {
		SnowbirdLiftAppBasicQueue app = new SnowbirdLiftAppBasicQueue();
		app.runLift();
	}
	...
	class Gad2Chair {
		...
		private SnowbirdLiftAppBasicQueue getOuterType() {
			return SnowbirdLiftAppBasicQueue.this;
		}
	}
}
